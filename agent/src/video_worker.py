...
from nodes.video_processor import VideoProcessorNode, VideoProcessorState
...
class VideoWorker:
    ...
    def __init__(self):
        ...
        # Initialize video processor node
        self.video_processor = VideoProcessorNode(num_frames=5)
    ...
    def process_and_update(self, job: dict) -> bool:
        ...
        try:
            ...
            result_state = self.video_processor(state)
