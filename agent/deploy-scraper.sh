...
if [ -z "$YOUTUBE_API_KEY" ]; then
    echo -e "${YELLOW}⚠️  WARNING: YOUTUBE_API_KEY is missing!${NC}"
    echo "   YouTube scraping will fallback to yt-dlp (slower, risk of bot detection)."
    echo "   To use official API, set YOUTUBE_API_KEY in ../.env"
